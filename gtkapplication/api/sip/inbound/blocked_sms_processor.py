...
class InboundProcessor:
	...
	def process_blocked_sms_message(self,message_body):
		self._logger.debug("entered process_blocked_sms_message")
		...
		db.insert_blocked_sms_message(from_phone_number)
		self._logger.debug("after db insert_blocked_sms_message()")
		...
		dashboard_ui.add_blocked_sms_notification(contact,active_contact_point_index)